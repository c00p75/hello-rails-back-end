...
A project to implement a connection between a Ruby on Rails for the back-end and React for the front end as one app using two two projects.

[LINK TO FRONT-END REPO](https://github.com/c00p75/hello-react-front-end)
...
> - Render random greeting from database.
...
Feel free to check the [issues page](https://github.com/c00p75/hello-rails-back-end/issues).
